							...
							<table width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td data-color="title" data-size="size title" data-min="25" data-max="45" data-link-color="link title color" data-link-style="text-decoration:none; color:#292c34;" class="title" align="left" style="font:35px/38px Arial, Helvetica, sans-serif; color:#292c34; padding:0 0 24px;">
										Bonjour, une nouvelle demande de création de compte a été faite sur l'application {{ config('app.name') }}
									</td>
								</tr>
								<tr>
									<td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:normal; text-decoration:underline; color:#40aceb;" align="left" style="font:normal 16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px;">
                                        <p>Nom : {{$demande->nom ? $demande->nom : 'N/C'}}</p>
                                        <p>Prénom : {{$demande->prenom ? $demande->prenom : 'N/C'}}</p>
                                        <p>Email : {{$demande->email ? $demande->email : 'N/C'}}</p>
                                        <p>Tel fixe : {{$demande->telephone_fixe ? $demande->telephone_fixe : 'N/C'}}</p>
                                        <p>Tel mobile : {{$demande->telephone_portable ? $demande->telephone_portable : 'N/C'}}</p>
                                        <p>Organisme de rattachement : {{$demande->organisme ? $demande->organisme : 'N/C'}}</p>
                                        <p>Motivation de la demande : {{$demande->motivation ? $demande->motivation : 'N/C'}}</p>
                                        <br />
                                        <p>Merci de valider ou refuser la demande depuis l'application.</p>
                                    </td>
								</tr>
                                <tr>
