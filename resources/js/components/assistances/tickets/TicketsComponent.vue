		...
		<b-container fluid class="mt--7" style="min-height: 60vh!important;">
	        <div class="card">
	            ...
	            <div class="card-body">
	            	...
	            	<p>Si vous rencontrez un bug/problème dans l'application, merci de saisir une description détaillée de celui-ci.</p>
		            ...
		            <div class="w-100 d-flex justify-content-center" v-else>
		            	<div class="card text-white bg-success mb-3">
							...
							<div class="card-body">
								...
								<p class="card-text">Merci pour votre message. L'application étant encore en développement, les tickets seront tous traités en fin d'année. </p>
							</div>
						</div>
		            </div>
	            </div>
